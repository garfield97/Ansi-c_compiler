...
%type <node> EXPR_LOGIC_AND EXPR_LOGIC_OR EXPR_CONDITIONAL OPR_ASSIGNMENT EXPR_CONST DECLARATION SPECIFIER_DECLARATION
...
%type <node> DECLARATION_EXTERNAL DEFINITION_FUNCTION
