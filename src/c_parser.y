...
%type <expr> EXPR,PRIMARY_EXPR,ARGUMENT_EXPR,UNARY_OPR,MULTI_EXPR,ADD_EXPR,SHIFT_EXPR,EQUAL_EXPR,RELAT_EXPR,AND_EXPR,XOR_EXPR,INCOR_EXPR,
             L_AND_EXPR,L_OR_EXPR,L_OR_EXPR,COND_EXPR,ASSIGN_EXPR,ASSIGN_OPR,CONST_EXPR,DEC,DEC_SPEC,TYPE_SPECIFIERS,STORAGE_CLASS_SPEC,STRUCT_SPEC,
